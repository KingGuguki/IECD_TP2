...
public class XMLDoc {
	...
	public static final String documentToStringFormatado(Document xmlDoc) throws TransformerFactoryConfigurationError, TransformerException 
	{
	    if (xmlDoc == null) 
	    {
	        return null;
	    ...
	    // Usar indentação apenas para os ficheiros
	...
	public synchronized static void gravarLock(Document documento, String ficheiroOriginal, String ficheiroBackup)
		...
		String stXML = documentToStringFormatado(documento);
