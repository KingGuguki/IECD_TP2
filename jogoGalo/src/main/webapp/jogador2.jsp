...
<%
	...
	// 🚿 LIMPEZA PREVENTIVA: Usa o método centralizado
    ...
    if ("Login".equals(acao) && stub != null) {
        try {
            ...
            session.setAttribute("simbolo_" + idSeparador, String.valueOf(simbolo));
...
<head>
    ...
    window.addEventListener('DOMContentLoaded', () => {
        ...
        function atualizarTempoJogo() {
            ...
            let minutes = Math.floor(totalSegundos / 60);
            let segundos = totalSegundos % 60;
            let formatoMin = minutes < 10 ? "0" + minutes : minutes;
